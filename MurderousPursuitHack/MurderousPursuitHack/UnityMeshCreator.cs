...
namespace MurderousPursuitHack
{
    ...
    public class UnityMeshCreator : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            _cube.transform.Translate(0f, 1f, 1f);
            ...
            _cube.transform.parent = Camera.main.transform;
            //Camera.main.gameObject.AddComponent<UnityMeshCreator>();
            //Camera.main.transform.position = new Vector3(Camera.main.transform.position.x, Camera.main.transform.position.y, -11f);
        }
        ...
        {
            //Rotate the cube
            _cube.GetComponent<Renderer>().material.color = new Color(0f, 0.7f, 0f, 1f);
            //cubeMaterial.SetColor("_Color", new Color(0f, 0.7f, 0f)); //green main color
        ...
        public void OnGUI()
        {
            GUI.Label(new Rect(0, 0, 1000, 1000), "XDDDDDDDDDDDDDDDDDDDD");
        }
    }
}